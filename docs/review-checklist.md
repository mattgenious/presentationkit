...
- [ ] First-version visual QA is still pending for unreviewed generated decks, or it is passed with final component-bundle evidence: full-slide renders, component/group crops, a component manifest, and an independent visual reviewer/subagent report.
