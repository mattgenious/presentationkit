...
- [ ] First-version visual QA is still pending for unreviewed generated decks, or it is passed with evidence from final rendered-slide artifacts and an independent visual reviewer/subagent.
